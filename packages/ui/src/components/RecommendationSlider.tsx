...
export const RecommendationSlider: React.FC<RecommendationSliderProps> = ({
  ...
  return (
    <section className="relative w-full max-w-7xl mx-auto px-6 py-20 bg-[#FDFBF7]">
      {/* Title */}
      ...
      <div className="relative group/slider">
        ...
        <div
          ...
          className="w-full flex space-x-6 overflow-x-auto scrollbar-none snap-x snap-mandatory pb-4 px-1"
